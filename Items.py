...
ITEM_TABLE: dict[str, TPItemData] = {
    ...
    "Spinner": TPItemData("Item", VERY_USEFUL, 33, 1, 0x41),
    "Ball and Chain": TPItemData("Item", VERY_USEFUL, 34, 1, 0x42),
    "Progressive Hero's Bow": TPItemData("Item", VERY_USEFUL, 35, 3, 0x43),
    "Progressive Clawshot": TPItemData("Item", VERY_USEFUL, 36, 2, 0x44),
