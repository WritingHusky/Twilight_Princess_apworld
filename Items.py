...
ITEM_TABLE: dict[str, TPItemData] = {
    ...
    "Male Beetle": TPItemData("Bug", IC.progression_skip_balancing, 96, 1, 0xC0),
    "Female Beetle": TPItemData("Bug", IC.progression_skip_balancing, 97, 1, 0xC1),
    "Male Butterfly": TPItemData("Bug", IC.progression_skip_balancing, 98, 1, 0xC2),
    "Female Butterfly": TPItemData("Bug", IC.progression_skip_balancing, 99, 1, 0xC3),
    "Male Stag Beetle": TPItemData("Bug", IC.progression_skip_balancing, 100, 1, 0xC4),
    "Female Stag Beetle": TPItemData(
        "Bug", IC.progression_skip_balancing, 101, 1, 0xC5
    ),
    "Male Grasshopper": TPItemData("Bug", IC.progression_skip_balancing, 102, 1, 0xC6),
    "Female Grasshopper": TPItemData(
        "Bug", IC.progression_skip_balancing, 103, 1, 0xC7
    ),
    "Male Phasmid": TPItemData("Bug", IC.progression_skip_balancing, 104, 1, 0xC8),
    "Female Phasmid": TPItemData("Bug", IC.progression_skip_balancing, 105, 1, 0xC9),
    "Male Pill Bug": TPItemData("Bug", IC.progression_skip_balancing, 106, 1, 0xCA),
    "Female Pill Bug": TPItemData("Bug", IC.progression_skip_balancing, 107, 1, 0xCB),
    "Male Mantis": TPItemData("Bug", IC.progression_skip_balancing, 108, 1, 0xCC),
    "Female Mantis": TPItemData("Bug", IC.progression_skip_balancing, 109, 1, 0xCD),
    "Male Ladybug": TPItemData("Bug", IC.progression_skip_balancing, 110, 1, 0xCE),
    "Female Ladybug": TPItemData("Bug", IC.progression_skip_balancing, 111, 1, 0xCF),
    "Male Snail": TPItemData("Bug", IC.progression_skip_balancing, 112, 1, 0xD0),
    "Female Snail": TPItemData("Bug", IC.progression_skip_balancing, 113, 1, 0xD1),
    "Male Dragonfly": TPItemData("Bug", IC.progression_skip_balancing, 114, 1, 0xD2),
    "Female Dragonfly": TPItemData("Bug", IC.progression_skip_balancing, 115, 1, 0xD3),
    "Male Ant": TPItemData("Bug", IC.progression_skip_balancing, 116, 1, 0xD4),
    "Female Ant": TPItemData("Bug", IC.progression_skip_balancing, 117, 1, 0xD5),
    "Male Dayfly": TPItemData("Bug", IC.progression_skip_balancing, 118, 1, 0xD6),
    "Female Dayfly": TPItemData("Bug", IC.progression_skip_balancing, 119, 1, 0xD7),
