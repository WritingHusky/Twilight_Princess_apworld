...
_simple_groups = {
    ("Sword", "Progressive Master Sword"),
    ("Swords", "Progressive Master Sword"),
    ("Progressive Sword", "Progressive Master Sword"),
    ("Progressive Swords", "Progressive Master Sword"),
    ("Wallet", "Progressive Wallet"),
    ("Bow", "Progressive Hero's Bow"),
    ("Progressive Bow", "Progressive Hero's Bow"),
    ("Dominion Rod", "Progressive Dominion Rod"),
    ("Dominion Rods", "Progressive Dominion Rod"),
    ...
    ("Fused Shadow", "Progressive Fused Shadow"),
